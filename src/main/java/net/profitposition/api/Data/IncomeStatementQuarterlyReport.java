...
public class IncomeStatementQuarterlyReport {
    ...
    public String totalOperatingExpense;
    ...
    public String otherOperatingExpense;
    public String interestExpense;
    public String taxProvision;
    ...
    public String totalOtherIncomeExpense;
    ...
    public String preferredStockAndOtherAdjustments;
    ...
    public String getTotalOperatingExpense() {
        return totalOperatingExpense;
    }

    public void setTotalOperatingExpense(String totalOperatingExpense) {
    ...
    public String getTotalOtherIncomeExpense() {
        return totalOtherIncomeExpense;
    }

    public void setTotalOtherIncomeExpense(String totalOtherIncomeExpense) {
        this.totalOtherIncomeExpense = totalOtherIncomeExpense;
    }
