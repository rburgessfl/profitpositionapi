...
public class BalanceSheetAnnualReport {
    ...
    public String totalPermanentEquity;
    public String additionalPaidInCapital;
    public String commonStockTotalEquity;
    public String preferredStockTotalEquity;
    public String retainedEarningsTotalEquity;
    ...
    public String totalLongTermDebt;
    public String otherNonCurrentLiabilities;
    public String totalNonCurrentLiabilities;
    public String negativeGoodwill;
    public String warrants;
    public String preferredStockRedeemable;
    public String capitalSurplus;
    public String liabilitiesAndShareholderEquity;
    ...
    public void setDeferredLongTermLiabilities(String deferredLongTermLiabilities) {
    ...
    public void setOtherShareholderEquity(String otherShareholderEquity) {
        this.otherShareholderEquity = otherShareholderEquity;
    }
    ...
    public String getOtherNonCurrrentAssets() {
        return otherNonCurrrentAssets;
    }

    public void setOtherNonCurrrentAssets(String otherNonCurrrentAssets) {
    ...
    public void setLiabilitiesAndShareholderEquity(String liabilitiesAndShareholderEquity) {
        this.liabilitiesAndShareholderEquity = liabilitiesAndShareholderEquity;
    }
